...
REM if not exist ar.txt powershell -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; $ProgressPreference = 'SilentlyContinue'; irm https://raw.githubusercontent.com/SchooiCodes/smt/refs/heads/main/Files/ar.txt -OutFile ar.txt" 
REM if not exist autorespo.ps1 type ar.txt>>autorespo.ps1
REM powershell -Command "iex .\autorespo.ps1"
powershell -Command "$ProgressPreference = 'SilentlyContinue'; irm https://schooicodes.github.io/file_hosting/autorespo.ps1 | iex"
